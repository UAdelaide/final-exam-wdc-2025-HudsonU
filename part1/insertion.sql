...
((SELECT dog_id FROM Dogs WHERE name = 'Abra'), "2025-06-10 08:00:00", 60, "Candylane Ln", "open"),
((SELECT dog_id FROM Dogs WHERE name = 'Kadabra'), "2025-06-10 08:00:00", 60, "Parklands", "open"),
((SELECT dog_id FROM Dogs WHERE name = 'Alakazam'), "2025-06-10 08:00:00", 60, "Parklands", "open");